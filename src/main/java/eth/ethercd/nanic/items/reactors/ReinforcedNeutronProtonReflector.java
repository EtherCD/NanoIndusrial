...
class ReinforcedNeutronProtonReflector extends ItemReactorIridiumReflector implements IReactorComponent, IHasModel {
    ReinforcedNeutronProtonReflector(String name) {
        super((ItemName)null);
