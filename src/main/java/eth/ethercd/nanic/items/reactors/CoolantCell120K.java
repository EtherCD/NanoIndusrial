...
public class CoolantCell120K extends ItemReactorCondensator implements IHasModel, IReactorComponent {
    public CoolantCell120K(String name) {
        super((ItemName)null, 120000);
